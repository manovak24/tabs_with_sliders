$(document).ready(function() {
    ...
    $('.tabs .tab-link').click(function() {
        ...
        $('.tabs .tab-link').removeClass('show-tab');
        $('.tab-content').removeClass('show-tab');
        $(this).addClass('show-tab');
        $('#' + tabId).addClass('show-tab');

        // Initialize accordion within the active tab
        $('#' + tabId + ' .accordionContainer').uberAccordion({
        headerClass: 'title',
        contentClass: 'content'
        });
    });

    // Initialize accordion within the first active tab
    $('.tab-content.show-tab .accordionContainer').uberAccordion({
        headerClass: 'title',
        contentClass: 'content'
    });
});
    ...
    class UberAccordion {
		constructor(parent, options) {
			...
			var defaults = {
				...
				orientationQuery: '(max-width: 700px)',
				startSlide: 1,
				openMultiple: false,
				autoPlay: false,
				autoPlaySpeed: 5000,
